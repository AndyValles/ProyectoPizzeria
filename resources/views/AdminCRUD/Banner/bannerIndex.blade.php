...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_BAN_CodigoInterno" name="Bus_BAN_CodigoInterno">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">TIPO BANNER:</p>
        <input type="text" class="input input-search-filter" id="Bus_TIPBAN_CodigoInterno" name="Bus_TIPBAN_CodigoInterno">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Paquete:</p>
        <input type="text" class="input input-search-filter" id="Bus_PAQ_CodigoInterno" name="Bus_PAQ_CodigoInterno">
    </div>
    <div class="w-80">
    ...
    <div class="w-50 df-ac-jc">
        <button class="btn btn-crud-Agregar" onclick="<?=$entidad?>Buscar()"><i class="icon-search"></i> Buscar</button>
    </div>
@endsection
...
@section("scripts")
    <script type="module"  src="{{ asset("/js/src/axios/crud/Banner/$entidad.min.js") }}"></script>
@endsection
