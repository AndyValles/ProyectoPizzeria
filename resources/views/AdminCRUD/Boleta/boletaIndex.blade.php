...
@section("input-buscar")
    ...
    <div class="w-50 df-ac-jc">
        <button class="btn btn-crud-Agregar" onclick="MarcaBuscar()"><i class="icon-search"></i> Buscar</button>
    </div>
@endsection
...
@section("paginate")
    <div class="df paginate_marca"><?= $paginate ?></div>
@endsection


@section("scripts")
    <script type="module"   src="{{ asset("/js/src/axios/crud/Marca/marca.min.js") }}"></script>
@endsection
