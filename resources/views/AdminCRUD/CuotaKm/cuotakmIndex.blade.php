...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_CKM_CodigoInterno" name="Bus_MAR_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Precio:</p>
        <input type="text" class="input input-search-filter" id="Bus_CKM_Precio" name="Bus_MAR_Nombre">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Metros:</p>
        <input type="text" class="input input-search-filter" id="Bus_CKM_Metros" name="Bus_MAR_Nombre">
    </div>
    <div class="w-80">
