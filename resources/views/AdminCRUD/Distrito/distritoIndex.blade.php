...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_DIS_Codigo" name="Bus_DIS_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_DIS_Nombre" name="Bus_DIS_Nombre">
    </div>
    <div class="w-80">
