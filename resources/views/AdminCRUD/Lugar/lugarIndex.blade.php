...
@section("input-buscar")
    ...
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_LUG_Codigo" name="Bus_LUG_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_LUG_Nombre" name="Bus_LUG_Nombre">
    </div>
    <div class="w-80">
