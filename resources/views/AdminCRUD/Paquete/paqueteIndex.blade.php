...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_PAQ_CodigoInterno" name="Bus_MAR_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_PAQ_Nombre" name="Bus_MAR_Nombre">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Fecha Registro:</p>
        <input type="text" class="input input-search-filter" id="Bus_PAQ_FechaRegistro" name="Bus_MAR_Nombre">
    </div>
    <div class="w-80">
