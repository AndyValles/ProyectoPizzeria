...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_PROV_Codigo" name="Bus_PROV_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_PROV_Nombre" name="Bus_PROV_Nombre">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Identificador:</p>
        <input type="text" class="input input-search-filter" id="Bus_PROV_Identificador" name="Bus_PROV_Identificador">
    </div>
    <div class="w-80">
