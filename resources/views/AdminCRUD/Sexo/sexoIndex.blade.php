...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_SEX_Codigo" name="Bus_SEX_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_SEX_Nombre" name="Bus_SEX_Nombre">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Identificador:</p>
        <input type="text" class="input input-search-filter" id="Bus_SEX_Identificador" name="Bus_SEX_Identificador">
    </div>
    <div class="w-80">
...
<div class="dropview-item"><div class="icon-checkbox-checked icon-rd" id="icon-CBK-Identificador"></div><input type="checkbox" class="input-custom" onclick="Filter_CBK('Identificador')" checked>Identificador</div>
...
<div class="table-cell tb_Identificador"><button class="btn bg-transparent w-100 " onclick="filter_table('Identificador')"> Identificador <i class="icon-bottom"></i></button> </div>
