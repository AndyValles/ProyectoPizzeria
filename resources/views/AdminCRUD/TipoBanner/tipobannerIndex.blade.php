...
@section("title","Tipo Banner")

@section("input-buscar")
    <div class="w-80">
        <p class="w-100 mr-10">Codigo:</p>
        <input type="text" class="input input-search-filter" id="Bus_TIPBAN_Codigo" name="Bus_TIPBAN_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_TIPBAN_Nombre" name="Bus_TIPBAN_Nombre">
    </div>
    <div class="w-80">
