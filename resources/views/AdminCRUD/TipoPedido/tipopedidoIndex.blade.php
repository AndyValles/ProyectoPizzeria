...
@section("input-buscar")
    <div class="w-80">
        ...
        <input type="text" class="input input-search-filter" id="Bus_TIPPED_Codigo" name="Bus_TIPPED_Codigo">
    </div>
    <div class="w-80">
        <p class="w-100 mr-10">Nombre:</p>
        <input type="text" class="input input-search-filter" id="Bus_TIPPED_Nombre" name="Bus_TIPPED_Nombre">
    </div>
    <div class="w-80">
